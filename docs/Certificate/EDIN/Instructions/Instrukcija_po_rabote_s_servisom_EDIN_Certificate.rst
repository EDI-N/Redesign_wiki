###########################################################################
Інструкція по роботі з сервісом Е-Сертифікати на web-платформі EDIN
###########################################################################
...
Якщо введена комбінація параметрів пошуку буде часто використовуватись, її можна зберегти для подальшого швидкого використання, натиснувши іконку |дискета| поруч з полем пошуку. При цьому з'явиться вікно для підтвердження збереження рядка пошуку:

.. image:: _constant/saving_search.png
   :align: center

Введіть назву для цього пошукового запиту та натисніть кнопку «Так*»

Для скидання результатів пошуку натисніть іконку |коло| поруч з полем пошуку.
 
6. Друк сертифіката з реквізитами КЕП
====================================================================

Щоб роздрукувати підписаний сертифікат, необхідно натиснути кнопку "**переглянути підписи**", яка знаходиться в колонці «**Дії**» списку сертифікатів:
