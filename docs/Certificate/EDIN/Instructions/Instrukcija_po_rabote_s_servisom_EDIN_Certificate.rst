...
- *Обмежений доступ* - доступ тільки обраним користувачам або мереж
...
Далі необхідно додати заповнений шаблон і всі підготовлені, відскановані файли в zip-архів.
...
Далі натисніть «**Завантажити zip-архів**» і в формі вибору файлів виберіть необхідний zip-архів.
