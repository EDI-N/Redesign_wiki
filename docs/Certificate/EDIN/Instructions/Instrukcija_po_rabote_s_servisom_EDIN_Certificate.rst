...
Після натискання кнопки «Далі» відкривається форма для додавання сертифікату у вкладення

.. image:: pics_Instrukcija_po_rabote_s_servisom_EDIN_Certificate/Instrukcija_po_rabote_s_servisom_EDIN_Certificate_05.png
   :align: center

Клікніть для вибору файлів або перетягніть у форматі PDF, JPG, JPEG, PNG, TIFF (розмір файла небільше 7 мб). Після завантаження файлу доданий сертифікат візуалізується. Для додавання до вкладень декількох сертифікатів використовується кнопка "Додати файл"
