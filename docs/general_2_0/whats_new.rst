...
+---------------------+-----------------------------+---------------------------------------------------+---------------------+-------------------------------+
|Доопрацювали логіку  |Доопрацювали логіку автоматич|Щоб забезпечити коректну логістику та автоматизацію|Для всіх користувачів|Так                            |
|розрахунку кількості |ного розрахунку кількості    |обліку замовлень, мінімізувати ручне втручання і   |сервісу Маркет       |                               |
|палет при            |палет при інтегрованій       |уникнути неточностей у доставці.                   |                     |`Посилання на XML специфікацію |
|інтегрованій         |відправці замовлення. Якщо в |                                                   |                     |<https://wiki.edin.ua/uk/latest|
|відправці замовлення |прайс-листі товарна позиція  |                                                   |                     |/Distribution/EDIN_2_0/XML/ORDE|
|                     |містить дані про кількість   |                                                   |                     |R_x.html>`__                   |
|                     |одиниць у коробці та         |                                                   |                     |                               |
|                     |кількість коробок на палеті, |                                                   |                     |                               |
|                     |система тепер самостійно вико|                                                   |                     |                               |
|                     |нує точний розрахунок кількос|                                                   |                     |                               |
|                     |ті палет. Навіть якщо        |                                                   |                     |                               |
|                     |покупець не передає          |                                                   |                     |                               |
|                     |інформацію про кількість     |                                                   |                     |                               |
|                     |палет у замовленні, система  |                                                   |                     |                               |
|                     |автоматично розраховує цей   |                                                   |                     |                               |
|                     |показник на основі прайс-    |                                                   |                     |                               |
|                     |листа.                       |                                                   |                     |                               |
+---------------------+-----------------------------+---------------------------------------------------+---------------------+-------------------------------+
...
|                     |   на відповідальне зберіган |                                                   |                     |id5>`__                        |
|                     |   ня" чи "Зняття з відповіда|                                                   |                     |                               |
|                     |   льного зберігання"), систе|                                                   |                     |                               |
|                     |   ма застосовує відповідну  |                                                   |                     |                               |
|                     |   логіку перевірок.         |                                                   |                     |                               |
|                     |#. Реалізували перевірку знач|                                                   |                     |                               |
|                     |   ення <ORDRTYPE> у документ|                                                   |                     |                               |
|                     |   ах ORDERS (family = 8,    |                                                   |                     |                               |
|                     |   DOCTYPE = О або R), що над|                                                   |                     |                               |
|                     |   ходять через FTP або API. |                                                   |                     |                               |
|                     |   Якщо для зв’язки Продавець|                                                   |                     |                               |
|                     |   → Покупець встановлено обм|                                                   |                     |                               |
|                     |   еження "allowed _ order _ |                                                   |                     |                               |
|                     |   subtype", документ        |                                                   |                     |                               |
|                     |   приймається лише за       |                                                   |                     |                               |
...
|                     |   виняток: система не       |                                                   |                     |                               |
|                     |   виконує перевірки на відпо|                                                   |                     |                               |
|                     |   відність обмеженням по    |                                                   |                     |                               |
|                     |   замовленню та товарам     |                                                   |                     |                               |
+---------------------+-----------------------------+---------------------------------------------------+---------------------+-------------------------------+
...
|                     |транзакцію, система          |                                                   |                     |                               |
|                     |автоматично створює для нього|                                                   |                     |                               |
|                     |всі наявні коригуючі Акти,   |                                                   |                     |                               |
|                     |які вже були створені по цій |                                                   |                     |                               |
|                     |ТТН та мають позитивно       |                                                   |                     |                               |
|                     |завершений життєвий цикл     |                                                   |                     |                               |
|                     |(ЖЦ). Попередня логіка       |                                                   |                     |                               |
|                     |залишилась актуальною — Акти |                                                   |                     |                               |
|                     |створюються всім поточним    |                                                   |                     |                               |
|                     |учасникам після завершення ЖЦ|                                                   |                     |                               |
|                     |відповідного Акта.           |                                                   |                     |                               |
+---------------------+-----------------------------+---------------------------------------------------+---------------------+-------------------------------+
...
|реєстрації та в GLN, |   ФОП виступає і            |                                                   |                     |                               |
|заповнення назви     |   перевізником, і водієм,   |                                                   |                     |                               |
|водія та перевізника |   він може одразу внести    |                                                   |                     |                               |
|у документах         |   дані посвідчення під час  |                                                   |                     |                               |
